...
.orange[$$\widehat{\sigma} = 11 \text{ cm}$$]
]
...
---
```{r, fig.height = 8, fig.width = 12}
plot_ci(0.80, EXPERIMENT_COUNT, POPULATION_SIZE, TRUE_LOCATION, TRUE_SCALE, SEED)
```

.right.green[Confidence level `r scales::percent(0.80)`]

---
```{r, fig.height = 8, fig.width = 12}
plot_ci(0.95, EXPERIMENT_COUNT, POPULATION_SIZE, TRUE_LOCATION, TRUE_SCALE, SEED)
```

.right.green[Confidence level `r scales::percent(0.95)`]
